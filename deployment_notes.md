...
```bash
sudo docker tag up-mavt-suite-backend  gitea.psi.ch/images/up-mavt-suite-backend:0.9.0
sudo docker tag up-mavt-suite-frontend gitea.psi.ch/images/up-mavt-suite-frontend:0.9.0
sudo docker tag up-mavt-suite-worker   gitea.psi.ch/images/up-mavt-suite-worker:0.9.0
```
...
```bash
sudo docker push gitea.psi.ch/images/up-mavt-suite-backend:0.9.0
sudo docker push gitea.psi.ch/images/up-mavt-suite-frontend:0.9.0
sudo docker push gitea.psi.ch/images/up-mavt-suite-worker:0.9.0
```
