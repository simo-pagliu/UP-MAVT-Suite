...
This module provides :class:`AdminService`, which centralises admin password
hashing and verification so the logic can be reused if multiple admin accounts
or more complex authentication flows are introduced in the future.
...
Hashing a new password (e.g. for initial setup)::
    ...
    hashed = AdminService.hash_password('my-secure-password')
...
class AdminService:
    ...
    def verify_password(plain_password: str, stored_password: str) -> bool:
        ...
        if AdminService._is_hashed(stored_password):
